<?php 
include("userResult2.php");

$getperiod_Query=mysqli_query($con,"select * from `tbl_gameid2` order by id desc limit 1");
...
$chkResult=mysqli_query($con,"select * from `tbl_result2` where `periodid`='".$periodid."'");
...
$ResultQuery= mysqli_query($con,"INSERT INTO `tbl_result2`(`periodid`, `price`, `randomprice`, `result`, `randomresult`, `color`, `randomcolor`, `resulttype`, `tabtype`,`createdate`) VALUES ('".$periodid."','".$tempTotal."','".$randomPrice."','".$tempNumber."','".$randomNumber."','".$tempColor."','".$randomColor."','real','".$type1."','".$today."')");	
...
$ResultQuery= mysqli_query($con,"INSERT INTO `tbl_result2`(`periodid`, `price`, `randomprice`, `result`, `randomresult`, `color`, `randomcolor`, `resulttype`, `tabtype`,`createdate`) VALUES ('".$periodid."','0','".$randomPrice."','0','".$randomNumber."','','".$newcolor."','random','".$type1."','".$today."')");	
//========final Result end===============================================	
	}
}//====parity end
	}
...
$ResultQuery= mysqli_query($con,"INSERT INTO `tbl_result2`(`periodid`, `price`, `randomprice`, `result`, `randomresult`, `color`, `randomcolor`, `resulttype`, `tabtype`,`createdate`) VALUES ('".$periodid."','0','".$randomPrice."','0','".$randomNumber."','','".$newcolor."','random','".$tabtypearray[$i]."','".$today."')");	
