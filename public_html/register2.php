          ...
          background-image: linear-gradient(147deg, #fff 0%, #fff 74%); " class="appContent1 mb-2">
           <form action="registerNow.php" method="post" class="card-body" autocomplete="off">
               ...
               <div class="inner-addon left-addon custom-left">
                  ...
                  <input type="tel" name="mobile" id="mobile"  class="form-control textbox textbox1 "  placeholder="Mobile" required>
               </div>
               ...
               <div class="inner-addon left-addon custom-left">
                  ...
                  <input type="email" name="email" id="email"  class="form-control textbox"  placeholder="Email" required>
               </div>
               ...
               <div class="inner-addon left-addon custom-left">
                  <div class="row">
                    <div class="col">
                      ...
                      <input type="number" name="otp" id="otp"  class="form-control textbox"  placeholder="Enter OTP" required>
                    </div>
                    <a class="col btn btn-warning" id="getOtp" onclick="getOtp()">Get OTP</a>
                    <a class="col btn btn-danger d-none" id="timer">00:00</a>
                  </div>
               </div>               
               ...
               <div class="inner-addon left-addon custom-left mt-3">
                  ...
                  <input type="password" name="password" id="password" class="form-control textbox "  placeholder="Password" required>
               </div>
               <div class="inner-addon left-addon custom-left mt-3">
                  <div class="number-img">
    ...
    if(email !=''){ 
     ...
     success: function(data) {
         if(data == 1){
             ...
             document.getElementById('regtoast').innerHTML = ('<font size="2" style="color:#000;">OTP Sent To Email!</font>');
            	$('#registertoast').modal({backdrop: 'static', keyboard: false})  
                $('#registertoast').modal('show');
         }
         else if(data == 0){
             document.getElementById('regtoast').innerHTML = ('<font size="2" style="color:#000;">Unable to Sent OTP !</font>');
            	$('#registertoast').modal({backdrop: 'static', keyboard: false})  
                $('#registertoast').modal('show');             
         }
     },
     ...
     document.getElementById('regtoast').innerHTML = ('<font size="2" style="color:#000;">Please Enter Valid Email !</font>');
    	$('#registertoast').modal({backdrop: 'static', keyboard: false})  
        $('#registertoast').modal('show');        
    }
