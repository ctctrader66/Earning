...
<html lang="en">
   ...
   <body>
      ...
      <div id="appCapsule">
         <div class="appContent1 mb-5">
            <div  class="mb-5" style="padding:0px 10px;">
               <p style="float:left"><span style="font-weight:500; color:#000; font-size:17px;">Total Amount: </span> <font style="font-size:24px; font-weight:500;">INR <span id="balance" > <?php echo number_format(wallet($con,'amount',$userid), 2);?></span></font><a href="javascript:void(0);" onClick="reloadbtn(<?php echo $userid;?>);"><img id="spin-image" class="walletimg1" src="images/brefresh.png"></a></p>
            ...
            <form  name="calculator" action="#" method="post" id="paymentdetailForm">
               <div class="boxinput mt-1 mb-1">
                  <div class="underinput">
                     <span style="font-size:25px;font-weight:600">inr</span>
      ...
      <script src="assets/js/payments.js.php"></script>
      <?php  include("assets/js/payments.js.php");?>
          <script>
