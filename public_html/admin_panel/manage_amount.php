...
$sql= "UPDATE `tbl_paymentsetting` SET `rechargeamount` = '$mra',`withdrawalamount` = '$mwa',`withdrawalamountusdt` = '$mwau',`interest` = '$ib',`rechargebonus` = '$rb',`rcomission` = '$rc',`level1` = '$level1',`level2` = '$level2' ,`level3` = '$level3' ,`transferamt` = '$transferamt' ,`withdrawal_status` = '$withdrawal_status',`bonusamount` = '$regbonus' WHERE `id`= '1'";
...
<div class="col-sm-6">
  ...
  <div class="col-sm-6">
              ...
              <label>Minimum Withdrawal TRX</label>
              ...
              <input type="text" class="form-control" onkeypress="return isNumber(event)" name="mwau" id="mwau" required value="<?php echo $role['withdrawalamountusdt'];?>">
 ...
 <div class="col-sm-6">
              ...
              <label>Minimum Tranfer Fund</label>

              <input type="text" class="form-control"  name="tr" id="tr" required value="<?php echo $role['transferamt'];?>">
...
<div class="col-sm-6">
              ...
              <label>Refer Bonus <i class="red_txt">[in %]</i></label>
