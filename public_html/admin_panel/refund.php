...
$sql= "UPDATE `content` SET `refund` = '$content' WHERE `id`= '1'";
$query=mysqli_query($con,$sql);
if($query){
	
	header("location:refund.php?msg=updt");
...
<label for="content">Refund Policy</label>
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["refund"]; ?></textarea>
</div></div>
