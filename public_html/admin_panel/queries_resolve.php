...
?>
 ...
 <a style=" background: seashell;"  class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h4 class="mb-1"><strong>Status:-</strong><?php    if($row["complaint_status"] == "1"){echo "Under Review";}
                               else if($row["complaint_status"] == "2"){echo "Pending";}
                               else if($row["complaint_status"] =="0"){echo "Ticket Solved";}
                              ?></h4>
     ...
     <form method="POST">
                ...
                <div class="card-body">
                  ...
                  <select style="width: 100%;" class="custom-select form-control-border" name="complaint_status" required>
                    ...
                    <option value="1">Under Reviews</option>
