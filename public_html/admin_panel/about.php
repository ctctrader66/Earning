...
$sql= "UPDATE `content` SET `about` = '$content' WHERE `id`= '1'";
$query=mysqli_query($con,$sql);
if($query){
	
	header("location:about.php?msg=updt");
...
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["about"]; ?></textarea>
</div></div>
