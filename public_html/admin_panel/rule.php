...
$sql= "UPDATE `content` SET `rule` = '$content' WHERE `id`= '1'";
$query=mysqli_query($con,$sql);
if($query){
	
	header("location:rule.php?msg=updt");
...
<head>
  ...
  <title>Admin Panel | Game Rule</title>
...
<label for="content">Game Rules</label>
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["rule"]; ?></textarea>
</div></div>
