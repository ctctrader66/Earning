...
<html>
   <head>
      ...
      <title>Admin Panel - Withdrawal Note</title>
   ...
   <body class="hold-transition skin-red sidebar-mini">
      <div class="wrapper">
         ...
         <?php include ("include/navigation.inc.php");
            ...
            $user_edit_query = mysqli_query($con, "SELECT * FROM tbl_withdrawal where id = $edit_user_id");
 ...
 <div class="row">
                  <div class="col-xs-12">
                     <h4 class="table_bg ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Withdrawal Note</h4>
                     <!-- /.box-header -->
                     <form action="" method="POST">
                        <div class="box-body blue_bg">
                          ...
                          <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 ...
                                 <input class="form-control"  name="u_mobile" type="text" value="<?php echo @$user_info_edit['note']; ?>">
                              </div>
                           </div>-->
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 <label> Note</label>
                                 <select name="u_mobile" class="form-control">
                                    <option value="1">Re-Submit With Correct Bank Or Upi Information</option>
                                    <option value="2">You Need To Complete 10X Bet Of Your Recharge</option>
                                    <option value="3">Failed, Because You Have Multiple Accounts</option>
      ...
      <script type="text/javascript">
         ...
         var strconfirm = confirm("Are you sure you want to cancel ?");
                   if (strconfirm == true) {
                   window.location = 'manage_withdrawReject.php'; 
                   }
...
$user_sql = "UPDATE tbl_withdrawal SET note='$user_mobile' WHERE id = $edit_user_id";
...
window.location.href="manage_withdrawReject.php";
</script>';
