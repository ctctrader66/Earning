...
<html lang="en">
   ...
   <body>
      ...
      <div id="header" class="appHeader1">
         <div class="pageTitle">6 Level</div>
      </div>
      <!-- * App Header -->
      <!-- App Capsule -->
      <div style="background:white; margin-top:55px" id="appCapsule container-fluid">
      ...
      <ul style="margin-bottom:-15px;" class="nav nav-tabs size3" id="myTab3" role="tablist">
         ...
         <li class="nav-item"> <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#level2" role="tab">Level 2 (<?php if($num == ""){echo "0";}else{echo $num;}?>)</a> </li>
         <li class="nav-item"> <a class="nav-link" id="home-tab3" data-toggle="tab" href="#level3" role="tab">Level 3 (<?php
            // level 3
                     $user1=mysqli_query($con,"select * from `tbl_user` where `id`='".$userid."'");
            $userRows1=mysqli_num_rows($user1);
            $userResult1=mysqli_fetch_array($user1);
      ...
      <div class="searchbar">
         <div class="inner-addon left-addon">
            ...
            <input  type="text" class="form-control textara" placeholder="search">
         </div>
      </div>
