...
$sql= "UPDATE `content` SET `terms` = '$content' WHERE `id`= '1'";
$query=mysqli_query($con,$sql);
if($query){
	
	header("location:terms.php?msg=updt");
...
<label for="content">Terms & Condition</label>
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["terms"]; ?></textarea>
</div></div>
