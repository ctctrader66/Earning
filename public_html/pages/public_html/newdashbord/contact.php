...
$sql= "UPDATE `content` SET `contact` = '$content' WHERE `id`= '1'";
$query=mysqli_query($con,$sql);
if($query){
	
	header("location:contact.php?msg=updt");
...
<label for="content">Contact us</label>
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["contact"]; ?></textarea>
</div></div>
