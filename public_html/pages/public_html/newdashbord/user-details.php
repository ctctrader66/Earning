  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php
          ...
          $total_recharge = mysqli_fetch_assoc(mysqli_query($con,"SELECT sum(price_amount) as total FROM `nowpayment` WHERE `payment_status` = 'finished' AND `userid` = '".$userid."'"));
          
          $total_withdraw = mysqli_fetch_assoc(mysqli_query($con,"SELECT sum(amount) as total FROM `tbl_withdrawal` WHERE status = 0 AND userid = '".$userid."'"));
           ...
           $total_bonusw = mysqli_fetch_assoc(mysqli_query($con,"SELECT sum(amount) as total FROM `tbl_bonuswithdrawal` where amount > 0 AND userid = '".$userid."'"));
            ...
            $total_reward = mysqli_fetch_assoc(mysqli_query($con,"SELECT sum(amount) as total FROM `tbl_reward` where userid = '".$userid."'"));
        ...
        <div class="row user-box" style="margin:0px;padding:0px;width:100%;">
            ...
            <div class="col-md-3 col-sm-12 col-lg-3 uinfo">
              ...
              <div class="col-md-3 col-sm-12 col-lg-3 uinfo">
               ...
               <div class="col-md-3 col-sm-12 col-lg-3 uinfo">
                <strong><a href="#total_bonus_w">Total Bonus Withdraw</a></strong>
                <h2>$<?= round($total_bonusw['total'],2);?></h2>
            </div>
            <div class="col-md-3 col-sm-12 col-lg-3 uinfo">
                 <strong><a href="#total_interest">Total Interest</a></strong>
                <h2>$<?=  round($total_interest['total'],2);?></h2>
            </div>
	...
	$ready = $link['total']; echo round($ready,2);?></h2>
                                    ...
                                    <td><?= $item['email']; ?></td>
                                      ...
                                      <td>		    $<?php
														    ...
														    $totalRecharge['total'] = 0;
                                                                $q = mysqli_query($con,"SELECT sum(price_amount) as total FROM `nowpayment` WHERE `payment_status` = 'finished' AND `userid` = '".$item['id']."'");
        ...
        <div id="total_withdrawal" class="row uinfo">
            ...
            <div id="total_bonus_w" class="row uinfo">
            <div class="col-lg-12 col-sm-12 col-xs-12 user-info">
                <span>BONUS WITHDRAW RECORD</span>
                <table id="example5" class="table table-condensed">
                    ...
                    <tbody>
                            ...
                            <?php
                                    ...
                                    while($item = mysqli_fetch_array($bonus_withdraw_record)){ ?>
                                        <tr>
                                            <td><?= $item['createdate'] ?></td>
                                            <td>$<?= $item['amount'] ?></td>
                        ...
                        <?php if(!empty($game_bet)){
                            while($item=mysqli_fetch_array($game_bet)) {  ?>
                                <tr>
                                    ...
                                    <td><a href="checkperoid.php?gameid=<?php echo $item['periodid'];?>&&color=<?php echo $item["value"];?>&&amount=<?php echo $item["amount"]; ?>"><?php echo $item['periodid'];?></a></td>
        ...
        <div id="total_interest" class="row uinfo">
            <div class="col-lg-12 col-sm-12 col-xs-12 user-info">
                ...
                <table id="example11" class="table table-condensed">
                    ...
                    <tbody>
                        <?php while($item=mysqli_fetch_array($interest)) { ?>
                        <tr>
