...
$user_sql = "UPDATE `tbl_user` SET `mobile`='$user_mobile',`email`='$user_email',`password`='".md5($user_pass)."',`owncode`='$user_code',`status`='$user_status',`view`='$user_pass',`wstatus`='$u_wstatus' WHERE `id`='$id'";
                     ...
                     <form action="" method="POST">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 <label > Withdrawal Status: <?php if( $user_info_edit['wstatus'] == '1'){echo 'ON';}else{echo 'OFF';}; ?></label>
