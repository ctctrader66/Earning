...
$sql= "UPDATE `content` SET `statement` = '$content' WHERE `id`= '1'";
$query=mysqli_query($con,$sql);
if($query){
	
	header("location:statement.php?msg=updt");
 ...
 ?> 
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">App Statement</li>
      </ol>
    </section>  
...
<label for="content">App Statement</label>
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["statement"]; ?></textarea>
</div></div>
