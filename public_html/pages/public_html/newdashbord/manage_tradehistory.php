...
<?php include ("include/header.inc.php");?>
 ...
 <div class="col-sm-12"><h3 style="color:#F39C12" class="text-center text-capitalize ">Filter By Date</h3></div>
              <div class="col-sm-6">
              <div class="form-group">
        ...
        <input type="submit" id="" name="Action" class="btn btn-warning" value="Download Excel">
                    </div>
                  </div>
              <!--</div>-->
<div class="row">              
