                  ...
                  <div class="appContent1 listView">
                     <table class="table">
                        ...
                        <tbody>
                           <?php
                              @$userid=$_SESSION['frontuserid'];
                                 $summery=mysqli_query($con,"select * from `tbl_userresult2` where `userid`='".$userid."' order by id desc");
                     ...
                     <?php   $total_bet1 = mysqli_query($con,"SELECT sum(amount) as total1 FROM `tbl_userresult2` where userid = '".$userid."' ");
